...
async function claim() {
    ...
    let contract = new ethers.Contract("0xd9128192d6E448368e8c036425f7a7F90D9aaA5f", abi, walletWithProvider);
    if(invinteAdr&&invinteAdr.slice(0,2)=="0x"){
        var claim = await contract.smashEggs(amount,invinteAdr);
      }else{
